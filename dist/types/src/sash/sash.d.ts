...
export declare class Sash extends EventEmitter implements Disposable {
     ...
     */
    constructor(container: HTMLElement, layoutProvider: VerticalSashLayoutProvider, options: SashOptions, shadowDocument: Document);
    /**
     ...
     * @param options The options.
     */
    constructor(container: HTMLElement, layoutProvider: HorizontalSashLayoutProvider, options: SashOptions, shadowDocument: Document);
