...
export declare class SplitView extends EventEmitter implements Disposable {
    ...
    constructor(container: HTMLElement, options: SplitViewOptions | undefined, shadowDocument: Document, onDidChange?: (sizes: number[]) => void, onDidDragStart?: (sizes: number[]) => void, onDidDragEnd?: (sizes: number[]) => void);
    /**
