...
export declare const App: ({ activity, activityBar, editorVisible, openEditors, panelVisible, primarySideBar, primarySideBarPosition, secondarySideBar, onActivityChanged, onEditorVisibleChanged, onOpenEditorsChanged, onPanelVisibleChanged, }: AppProps) => import("react/jsx-runtime").JSX.Element;
